...
['setMenuBg','setMenuSurface','setMenuText','setCategoryBg','setCategoryText','setCardRadius','setMenuDensity','setMobileColumns','setShowHero','setStickyCategories','setShowFeatureStrip'].forEach(id=>$('#'+id)?.addEventListener('input',()=>paintThemePreview()));
